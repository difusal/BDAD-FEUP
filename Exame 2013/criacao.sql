...
insert into aplicacao(nome, descricao) values ("sigarra", "Gestao Entidades");
insert into aplicacao(nome, descricao) values ("redmine", "Controlo de versoes");
...
insert into servidor(idResponsavel, hostname) values (1, "porto");
insert into servidor(idResponsavel, hostname) values (1, "lisboa");
insert into servidor(idResponsavel, hostname) values (3, "evora");
insert into servidor(idResponsavel, hostname) values (2, "lagos");
insert into servidor(idResponsavel, hostname) values (3, "alu1");
...
insert into AplicacaoServidor(idAplicacao, idServidor) values (3, 6);
